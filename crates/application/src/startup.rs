...
use crate::ai_subscriber::AiSubscriber;
...
pub fn register_core_subscribers(bus: &mut EventBus) {
    ...
    // ═══ AI subscriber ══════════════════════════════════════════════
    // Handles reactive decisions for AI players (buy cards, pay bail, etc.)
    // in a separate module to avoid mixing with core game logic.
    bus.subscribe(Box::new(AiSubscriber));
    // ═════════════════════════════════════════════════════════════════
